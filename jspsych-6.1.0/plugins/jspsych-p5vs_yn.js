jsPsych.plugins["p5vs_yn"] = (function() {
    ...
    trial.distractor_positions = positions.slice(1,trial.set_size+1)

		trial.jitter = p.random(500)
    ...
    function presentArray () {
      ...
      p.text('press '+trial.choices[1].toUpperCase() +
             ' for yes and '+trial.choices[0].toUpperCase() +' for no',0,du/2+20,)

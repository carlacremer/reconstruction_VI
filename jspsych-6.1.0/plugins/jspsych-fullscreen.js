  ...
  plugin.info = {
    ...
    parameters: {
      ...
      message: {
        ...
        pretty_name: 'Message',
        default: '<p>Please select a player ID, part and round on the next page to view the reconstructed game of a participant from Experiment: Self-Modelling of Counterfactual Knowledge States (Carla Cremer & Matan Mazor 2025)</p>',
        array: false,
